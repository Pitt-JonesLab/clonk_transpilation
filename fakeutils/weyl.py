...
def weyl_coordinates(U):
    ...
    if isinstance(U, sympy.Matrix):
        ...
        D_dict = (Up.T @ Up).eigenvals()
        # convert sympy eigenval dict to list repeated according to multiplicity
        D = []
...
# weyl_coordinates(Operator(CRZGate(theta)).data)
